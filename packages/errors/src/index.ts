...
export const ErrorCode = {
  ...
  // Intake (M4 — AI assistant)
  INTAKE_NOT_FOUND: 'INTAKE_NOT_FOUND',
  INTAKE_INVALID_STATE: 'INTAKE_INVALID_STATE',
  INTAKE_MAX_MESSAGES_EXCEEDED: 'INTAKE_MAX_MESSAGES_EXCEEDED',
  // AI provider (M4)
  AI_PROVIDER_UNAVAILABLE: 'AI_PROVIDER_UNAVAILABLE',
  AI_PROVIDER_INVALID_OUTPUT: 'AI_PROVIDER_INVALID_OUTPUT',
...
export const ErrorStatus: Record<ErrorCode, number> = {
  ...
  INTAKE_INVALID_STATE: 409,
  INTAKE_MAX_MESSAGES_EXCEEDED: 400,
...
export const ErrorMessage: Record<ErrorCode, string> = {
  ...
  INTAKE_NOT_FOUND: 'Conversation not found.',
  INTAKE_INVALID_STATE: 'Conversation is no longer accepting messages.',
  INTAKE_MAX_MESSAGES_EXCEEDED: 'Conversation has reached the message limit.',
  AI_PROVIDER_UNAVAILABLE: 'The AI assistant is currently unavailable.',
  AI_PROVIDER_INVALID_OUTPUT: 'The AI assistant returned an unexpected response.',
  AI_RATE_LIMITED: 'The AI assistant is rate-limited. Please try again shortly.',
